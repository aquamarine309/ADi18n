...
export class TimeStudyTreeLayout {
  constructor(type, scaling = 1) {
    ...
    const namelessStudy = {};
    this.namelessStudy = new TimeStudySetup({
      study: namelessStudy,
      row: 0,
      column: 2
    });
    ...
    this.namelessStudyConnection = new TimeStudyConnectionSetup(
      new TimeStudyConnection(TS(11), namelessStudy)
    );
    ...
    this.namelessStudy.setPosition(this);
    ...
    this.namelessStudyConnection.setPosition(this.studies.concat(this.namelessStudy), this.width, this.height);
  }
