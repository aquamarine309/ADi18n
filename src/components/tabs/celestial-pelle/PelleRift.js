        ...
        >
          ...
          >
            ...
            <div
              ...
              data-v-pelle-rift
            >
              {{ $t("rift_drains_to_fill_part_1") }} {{ drainResource() }} {{ $t("rift_drains_to_fill_part_2") }}
              <span
                v-if="specialRift"
              ...
              <template v-if="!isMaxed">
                {{ $t("rift_currency_amount", formatRift(resource)) }}
              </template>
              <br>
              {{ $t("rift_total_filled", formatRift(rift.totalFill)) }}
            </div>
          </div>
        </div>
      </div>
