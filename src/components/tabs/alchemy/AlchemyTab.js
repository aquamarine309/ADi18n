...
export default {
  ...
  <div class="l-ra-alchemy-tab">
    <div class="c-subtab-option-container">
      ...
      >
        {{ $t(allReactionsDisabled ? "enable_all_reactions" : "disable_all_reactions") }}
      </PrimaryButton>
      <PrimaryButton
    ...
    />
    <br>
    {{ $t("alchemy_disclaimer", formatX(capFactor)) }}
    <span v-if="reactionsAvailable">
    {{ $t("alchemy_disclaimer_reactions") }}
    </span>
    <div
