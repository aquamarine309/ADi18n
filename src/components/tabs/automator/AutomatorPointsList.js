    ...
    >
      ...
      >
        ...
        <span
          ...
          data-v-automator-points-list
        >{{ $t("X_ap", formatInt(fromPerks)) }}</span>
        <span
          class="l-large-text"
          data-v-automator-points-list
        >
        ...
        >
          ...
          <span
            ...
            data-v-automator-points-list
          >{{ $t("X_ap", formatInt(perk.automatorPoints)) }}</span>
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          <span
            class="c-automator-points-list-ap--large"
            data-v-automator-points-list
          >{{ $t("X_ap", formatInt(source.automatorPoints())) }}</span>
          <span
            class="l-large-text"
            data-v-automator-points-list
          >
      ...
      >
        ...
        <span
          class="c-automator-points-list-ap--large"
          data-v-automator-points-list
        >{{ $t("X_ap", formatInt(fromUpgrades)) }}</span>
        <span
          class="l-large-text"
          data-v-automator-points-list
        >
        ...
        >
          ...
          <span
            class="c-automator-points-list-ap"
            data-v-automator-points-list
          >{{ $t("X_ap", formatInt(upgrade.automatorPoints)) }}</span>
          <br>
