...
export default {
  ...
  computed: {
    ...
    hasReward() {
      return this.achievement.hasReward && !this.isObscured;
    },
  ...
  methods: {
    update() {
      ...
      this.processedName = this.processText(this.achievement.name, this.garbledNameTemplate);
      this.processedId = this.processText(this.displayId, this.garbledIDTemplate);
      this.processedDescription = this.processText(this.achievement.description, this.garbledDescriptionTemplate);
      ...
      <template v-if="isMouseOver">
        ...
        >
          <span
            ...
            data-v-normal-achievement
          >
            {{ $t("X_colon_Y", $t("reward"), achievement.reward) }}
            <EffectDisplay
