...
export default {
  ...
  methods: {
    ...
    glyphBorderStyle() {
      ...
      let borderAttrs;
      if (this.isCursedGlyph) borderAttrs = rarityBorderStyles[8];
      else if (this.isCompanionGlyph) borderAttrs = rarityBorderStyles[9];
      else borderAttrs = rarityBorderStyles[getRarity(this.glyph.strength).id];
