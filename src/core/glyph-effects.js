...
class GlyphEffectConfig {
  ...
  * @param {string} setup.singleDesc Specify how to show a single glyph's effect. Use a string with {1}
  ...
  *  glyphs.
  * @param {string} [setup.genericDesc] (Defaults to singleDesc with {1} replaced with "x") Generic
  ...
  */
  constructor(setup) {
    ...
    this._genericDesc = () => (setup.genericDesc ?? setup.singleDesc)().replace("{1}", "x");
