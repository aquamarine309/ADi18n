...
EventHub.logic.on(GAME_EVENT.SINGULARITY_RESET_AFTER, () => {
  ...
  if (newMilestones === 1) GameUI.notify.blackHole($t("singularity_milestone_reached"));
  else GameUI.notify.blackHole($t("singularity_milestones_reached", formatInt(newMilestones)));
