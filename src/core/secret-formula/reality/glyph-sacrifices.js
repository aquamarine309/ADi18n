export const glyphSacrifice = {
  "power": {
    ...
    description: amount => {
      ...
      const nextGalaxyText = amount < 750
        ? ` ${$t("next_at_X", format(nextDistantGalaxy, 2, 2))}`
        : "";
      return $t("glyph_sacrifice_power_description", formatInt(amount), nextGalaxyText);
    },
  ...
  "infinity": {
    ...
    description: amount => $t("glyph_sacrifice_infinity_description", formatX(amount, 2, 2)),
    cap: () => GlyphSacrificeHandler.maxSacrificeForEffects
  },
  "time": {
    id: "time",
    ...
    description: amount => $t("glyph_sacrifice_time_description", formatX(amount, 2, 2)),
    cap: () => GlyphSacrificeHandler.maxSacrificeForEffects
  },
  "replication": {
    id: "replication",
    ...
    description: amount => {
      ...
      const nextGalaxyText = amount < 1500
        ? ` ${$t("next_at_X", format(nextDistantGalaxy, 2, 2))}`
        : "";
      return $t("glyph_sacrifice_replication_description", formatInt(amount), nextGalaxyText);
    },
    cap: () => GlyphSacrificeHandler.maxSacrificeForEffects
  },
  "dilation": {
    ...
    description: amount => $t("glyph_sacrifice_dilation_description", formatX(amount, 2, 2)),
    cap: () => GlyphSacrificeHandler.maxSacrificeForEffects
  },
  "effarig": {
    id: "effarig",
    ...
    description: amount => $t("glyph_sacrifice_dilation_description", formatPercents(amount / 100, 2)),
    cap: () => 1e70
  },
  "reality": {
    id: "reality",
    ...
    description: amount => $t("glyph_sacrifice_dilation_description", formatX(amount, 2, 3)),
    cap: () => GlyphSacrificeHandler.maxSacrificeForEffects
  }
};
