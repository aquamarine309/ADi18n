...
export const discordRichPresence = {
  ...
  challenges: [
    ...
    {
      name: () => `${Nameless.possessiveName} Reality`,
      activityToken: () => Nameless.isRunning,
  ...
  stages: [
    ...
    },
    {
      ...
      resourceList: [
        () => `Best GL: ${formatInt(player.records.bestReality.glyphLevel)}`,
        () => `Charged: ${format(TimeSpan.fromMilliseconds(player.celestials.nameless.stored).totalYears, 2)} years`
      ],
    },
    {
      name: () => V.displayName,
