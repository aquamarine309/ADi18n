...
export const v = {
  ...
  runUnlocks: [
    {
      id: 0,
      name: () => $t("v_run_unlock_0_name"),
      description: value => $t("v_run_unlock_0_description", formatInt(-value)),
      ...
      formatRecord: x => (x >= -5 ? formatInt(-x) : $t("not_reached_yet")),
      shardReduction: () => 0,
      maxShardReduction: () => 0,
    ...
    {
      id: 1,
      name: () => $t("v_run_unlock_1_name"),
      description: value => $t("v_run_unlock_1_description", formatInt(value)),
    ...
    {
      id: 2,
      name: () => $t("v_run_unlock_2_name"),
      description: value => $t("v_run_unlock_2_description", format(Decimal.pow10(value))),
    ...
    {
      id: 3,
      name: () => $t("v_run_unlock_3_name"),
      description: value => $t("v_run_unlock_3_description", format(Decimal.pow10(value))),
    ...
    {
      id: 4,
      name: () => $t("v_run_unlock_4_name"),
      description: value => $t("v_run_unlock_4_description", format(Decimal.pow10(value))),
    ...
    {
      id: 5,
      name: () => $t("v_run_unlock_5_name"),
      description: value => $t("v_run_unlock_5_description", formatInt(value)),
    ...
    {
      id: 6,
      name: () => $t("v_run_unlock_6_name"),
      description: value => $t("v_run_unlock_6_description", formatInt(-value)),
      // This achievement has internally negated values since the check is always greater than
      values: [1, 4, 7, 10, 13],
      condition: () => V.isRunning && TimeStudy.reality.isBought,
    ...
    {
      id: 7,
      name: () => $t("v_run_unlock_7_name"),
      description: value => $t("v_run_unlock_7_description", formatInt(400000), format(Decimal.pow10(value), 2, 2)),
    ...
    {
      id: 8,
      name: () => $t("v_run_unlock_8_name"),
      description: value => $t("v_run_unlock_8_description", formatInt(value)),
  ...
  unlocks: {
    vAchievementUnlock: {
      id: 0,
      reward: () => $t("v_milestone_0_reward"),
      description: () => $t("v_milestone_1_description"),
    ...
    fastAutoEC: {
      ...
      format: x => (Ra.unlocks.instantECAndRealityUpgradeAutobuyers.canBeApplied
        ? $t("v_milestone_3_effect_ra")
        : $t("v_milestone_3_effect", TimeSpan.fromMinutes(60 * 20 / x).toStringShort())),
