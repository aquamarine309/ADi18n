...
export const singularityMilestones = {
  ...
  continuumMult: {
    ...
    limit: Infinity,
    description: () => $t("singularity_milestone_0_description"),
  ...
  darkMatterMult: {
    ...
    limit: Infinity,
    description: () => $t("singularity_milestone_1_description"),
  ...
  darkEnergyMult: {
    ...
    limit: Infinity,
    description: () => $t("singularity_milestone_2_description"),
  ...
  darkDimensionCostReduction: {
    ...
    limit: Infinity,
    description: () => $t("singularity_milestone_3_description"),
  ...
  singularityMult: {
    ...
    increaseThreshold: 5,
    limit: Infinity,
    description: () => $t("singularity_milestone_4_description"),
    effect: completions => Math.pow(2, completions),
  ...
  darkDimensionIntervalReduction: {
    ...
    increaseThreshold: 20,
    limit: Infinity,
    description: () => $t("singularity_milestone_5_description"),
  ...
  improvedAscensionDM: {
    ...
    limit: Infinity,
    description: () => $t("singularity_milestone_6_description"),
  ...
  ascensionIntervalScaling: {
    ...
    repeat: 2400,
    limit: 8,
    description: () => $t("singularity_milestone_7_description"),
  ...
  autoCondense: {
    ...
    repeat: 80,
    limit: 8,
    description: () => $t("singularity_milestone_8_description"),
  ...
  darkDimensionAutobuyers: {
    ...
    repeat: 170,
    limit: 4,
    description: () => $t("singularity_milestone_9_description"),
  ...
  ascensionAutobuyers: {
    ...
    repeat: 140,
    limit: 4,
    description: () => $t("singularity_milestone_10_description"),
    effect: completions => completions,
  ...
  darkAutobuyerSpeed: {
    ...
    repeat: 650,
    limit: 8,
    description: () => $t("singularity_milestone_11_description"),
  ...
  realityDEMultiplier: {
    ...
    repeat: 10000,
    limit: 6,
    description: () => $t("singularity_milestone_12_description"),
  ...
  improvedSingularityCap: {
    ...
    repeat: 10000,
    limit: 4,
    description: () => $t("singularity_milestone_13_description"),
  ...
  intervalCostScalingReduction: {
    ...
    repeat: 50000,
    limit: 5,
    description: () => $t("singularity_milestone_14_description"),
  ...
  darkFromTesseracts: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_15_description"),
  ...
  multFromInfinitied: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_16_description"),
  ...
  dilatedTimeFromSingularities: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_17_description"),
  ...
  darkFromGlyphLevel: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_18_description"),
  ...
  gamespeedFromSingularities: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_19_description"),
  ...
  darkFromTheorems: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_20_description"),
  ...
  dim4Generation: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_21_description"),
  ...
  darkFromDM4: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_22_description"),
  ...
  annihilationAutobuyer: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_23_description"),
    effect: completions => completions,
  ...
  theoremPowerFromSingularities: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_24_description"),
  ...
  darkFromGamespeed: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_25_description"),
  ...
  glyphLevelFromSingularities: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_26_description"),
  ...
  darkFromDilatedTime: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_27_description"),
  ...
  infinitiedPow: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_28_description"),
  ...
  tesseractMultFromSingularities: {
    ...
    repeat: 0,
    limit: 1,
    description: () => $t("singularity_milestone_29_description"),
