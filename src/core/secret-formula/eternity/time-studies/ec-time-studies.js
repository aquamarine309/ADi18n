...
export const ecTimeStudies = [
  {
    ...
    secondary: {
      resource: () => $t("eternities"),
      current: () => Currency.eternities.value,
      required: completions => new Decimal(20000 + Math.min(completions, Nameless.isRunning ? 999 : 4) * 20000),
