...
export const eternityUpgrades = {
  idMultEP: {
    id: 1,
    cost: 5,
    description: () => $t("eternity_upgrade_0", formatInt(1)),
  ...
  idMultEternities: {
    id: 2,
    cost: 10,
    description: () => $t("eternity_upgrade_1"),
    effect() {
  ...
  idMultICRecords: {
    id: 3,
    cost: 5e4,
    description: () => $t("eternity_upgrade_2"),
  ...
  tdMultAchs: {
    id: 4,
    cost: 1e16,
    description: () => $t("eternity_upgrade_3"),
  ...
  tdMultTheorems: {
    id: 5,
    cost: 1e40,
    description: () => $t("eternity_upgrade_4"),
  ...
  tdMultRealTime: {
    ...
    description: () => (Pelle.isDoomed
      ? $t("eternity_upgrade_5_doomed")
      : $t("eternity_upgrade_5")
    ),
